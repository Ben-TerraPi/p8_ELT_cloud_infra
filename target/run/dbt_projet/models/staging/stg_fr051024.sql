  ...
  create view "postgres_db"."projet_8"."stg_fr051024__dbt_tmp"
...
with source as (
  select * from "postgres_db"."projet_8"."fr051024"
)

select
  _airbyte_raw_id,
  ('2024-10-05'::date + to_timestamp("Time", 'HH:MI AM')::time)::timestamp as date_time,
