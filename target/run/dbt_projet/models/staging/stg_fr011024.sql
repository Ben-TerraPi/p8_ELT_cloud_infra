  ...
  create view "postgres_db"."projet_8"."stg_fr011024__dbt_tmp"
...
with source as (
  select * from "postgres_db"."projet_8"."fr011024"
)

select
  _airbyte_raw_id,
  ('2024-10-01'::date + to_timestamp("Time", 'HH:MI AM')::time)::timestamp as date_time,
