  ...
  create view "postgres_db"."projet_8"."stg_fr071024__dbt_tmp"
...
with source as (
  select * from "postgres_db"."projet_8"."fr071024"
)

select
  _airbyte_raw_id,
  ('2024-10-07'::date + to_timestamp("Time", 'HH:MI AM')::time)::timestamp as date_time,
