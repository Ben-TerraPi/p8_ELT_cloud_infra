  ...
  create view "postgres_db"."projet_8"."stg_fr061024__dbt_tmp"
...
with source as (
  select * from "postgres_db"."projet_8"."fr061024"
)

select
  _airbyte_raw_id,
  ('2024-10-06'::date + to_timestamp("Time", 'HH:MI AM')::time)::timestamp as date_time,
