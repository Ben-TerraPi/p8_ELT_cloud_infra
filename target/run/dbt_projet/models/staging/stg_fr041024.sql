  ...
  create view "postgres_db"."projet_8"."stg_fr041024__dbt_tmp"
...
with source as (
  select * from "postgres_db"."projet_8"."fr041024"
)

select
  _airbyte_raw_id,
  ('2024-10-04'::date + to_timestamp("Time", 'HH:MI AM')::time)::timestamp as date_time,
